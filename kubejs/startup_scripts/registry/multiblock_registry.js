...
GTCEuStartupEvents.registry("gtceu:recipe_type", event => {
    ...
    event.create("large_auto_crafter")
        ...
        .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, FillDirection.LEFT_TO_RIGHT)
        .setSound(GTSoundEntries.COMPUTATION)
    event.create("large_combination_crafter")
        .category("multiblock")
        .setEUIO("in")
        .setMaxIOSize(27, 1, 0, 0)
        .setProgressBar(GuiTextures.PROGRESS_BAR_ARROW, FillDirection.LEFT_TO_RIGHT)
    ...
    event.create("ore_processing_factory")
        .category("multiblock")
        .setEUIO("in")
...
GTCEuStartupEvents.registry("gtceu:machine", event => {
    ...
    event.create("simulation_supercomputer", "multiblock")
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .where("C", Predicates.blocks("kubejs:dark_steel_casing").setMinGlobalLimited(14)
    ...
    event.create("antimatter_collider", "multiblock")
        ...
        .pattern(definition => FactoryBlockPattern.start()
            ...
            .aisle("MMMAMMMAMMM", "##ACAAACA##", "###A###C###", "###########", "###########", "##C########", "####OOO####", "####G@G####", "####OOO####", "###########", "###########", "###########", "###B###B###", "##BCBBBCB##", "MMMBMMMBMMM")
    ...
    event.create("large_auto_crafter", "multiblock")
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes(["large_auto_crafter", "large_combination_crafter"])
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_PERFECT_SUBTICK])
    ...
    // Large Greenhouse (hydroponics plant)
    event.create("hydroponics_plant", "multiblock")
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes("greenhouse")
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_PERFECT_SUBTICK])
        .appearanceBlock(GTBlocks.CASING_STEEL_SOLID)
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("#CCCCCCC#", "#CWWWWWC#", "#CWWEWWC#", "#CWWWWWC#", "#CGGWGGC#", "#CGGWGGC#", "##CCBCC##")
            .aisle("BCWWWWWCB", "BWFFFFFWB", "BW#####WB", "BW#####WB", "BG#####GB", "#B##P##B#", "##BBBBB##")
            .aisle("#CWWWWWC#", "#WFFFFFW#", "#E#####E#", "#W#####W#", "#G#####G#", "#G##P##G#", "##GGGGG##")
            .aisle("#CWWWWWC#", "#WFFFFFW#", "#W#####W#", "#W#####W#", "#G#####G#", "#G##P##G#", "##GGGGG##")
            .aisle("#CWWWWWC#", "#WFFFFFW#", "#W#####W#", "#W#####W#", "#G#####G#", "#G##P##G#", "##GGGGG##")
            .aisle("#CWWWWWC#", "#WFFFFFW#", "#E#####E#", "#W#####W#", "#G#####G#", "#G##P##G#", "##GGGGG##")
            .aisle("#CWWWWWC#", "#WFFFFFW#", "#W#####W#", "#W#####W#", "#G#####G#", "#G##P##G#", "##GGGGG##")
            .aisle("#CWWWWWC#", "#WFFFFFW#", "#W#####W#", "#W#####W#", "#G#####G#", "#G##P##G#", "##GGGGG##")
            .aisle("#CWWWWWC#", "#WFFFFFW#", "#E#####E#", "#W#####W#", "#G#####G#", "#G##P##G#", "##GGGGG##")
            .aisle("BCWWWWWCB", "BWFFFFFWB", "BW#####WB", "BW#####WB", "BG#####GB", "#B##P##B#", "##BBBBB##")
            .aisle("#CCC@CCC#", "#CWWWWWC#", "#CWWEWWC#", "#CWWWWWC#", "#CGGWGGC#", "#CGGWGGC#", "##CCBCC##")
            .where("@", Predicates.controller(Predicates.blocks(definition.get())))
            ...
            .where("F", Predicates.blocks("farmersdelight:rich_soil")
                ...
                .or(Predicates.blocks("farm_and_charm:fertilized_soil"))
                .or(Predicates.blocks("farm_and_charm:fertilized_farmland"))
                .or(Predicates.blocks("mynethersdelight:resurgent_soil"))
                .or(Predicates.blocks("mynethersdelight:resurgent_soil_farmland")))
            .where("E", Predicates.blocks("gtceu:engine_intake_casing"))
            .where("P", Predicates.blocks("gtceu:titanium_pipe_casing"))
            .where("W", Predicates.blocks("gtceu:watertight_casing"))
            .where("B", Predicates.blocks("gtceu:hard_carbon_frame"))
            .where("#", Predicates.any())
            .where(" ", Predicates.air())
            .build())
        .workableCasingModel("gtceu:block/casings/solid/machine_casing_solid_steel",
    ...
    event.create("industrial_fishery", "multiblock")
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes("industrial_fishery")
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_NON_PERFECT_SUBTICK])
        .appearanceBlock(() => Block.getBlock("gtceu:clean_machine_casing"))
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("F#CCCC#F", "F#CCCC#F", "F#CCCC#F", "F#CCCC#F", "FFCCCCFF", "##F##F##")
            .aisle("#CCCCCC#", "#CPPPPC#", "#CWWWWC#", "#CWWWWC#", "FCWWWWCF", "#CCGGCC#")
            .aisle("CCCCCCCC", "CPWWWWPC", "CWWWWWWC", "CWWWWWWC", "CWWWWWWC", "FCGGGGCF")
            .aisle("CCCCCCCC", "CPWWWWPC", "CWWWWWWC", "CWWWWWWC", "CWWWWWWC", "#GGGGGG#")
            .aisle("CCCCCCCC", "CPWWWWPC", "CWWWWWWC", "CWWWWWWC", "CWWWWWWC", "#GGGGGG#")
            .aisle("CCCCCCCC", "CPWWWWPC", "CWWWWWWC", "CWWWWWWC", "CWWWWWWC", "FCGGGGCF")
            .aisle("#CCCCCC#", "#CPPPPC#", "#CWWWWC#", "#CWWWWC#", "FCWWWWCF", "#CCGGCC#")
            .aisle("F#CCCC#F", "F#CC@C#F", "F#CCCC#F", "F#CCCC#F", "FFCCCCFF", "##F##F##")
            .where("@", Predicates.controller(Predicates.blocks(definition.get())))
            .where("C", Predicates.blocks("gtceu:clean_machine_casing").setMinGlobalLimited(16)
                .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                .or(Predicates.abilities(PartAbility.INPUT_LASER).setMaxGlobalLimited(1))
                .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1))
                .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1)))
    ...
    event.create("ore_processing_factory", "multiblock")
        .rotationState(RotationState.NON_Y_AXIS)
        .recipeTypes("ore_processing_factory")
        .recipeModifiers([GTRecipeModifiers.PARALLEL_HATCH, GTRecipeModifiers.OC_PERFECT_SUBTICK])
        .appearanceBlock(() => Block.getBlock("gtceu:sturdy_machine_casing"))
        .pattern(definition => FactoryBlockPattern.start()
            .aisle("#CCC#####CCC#", "#HHH#####HHH#", "#SES#####SES#", "#SES#####SES#", "##F#######F##", "##F#######F##", "#############", "#############", "#############", "#############")
            .aisle("CCCCC###CCCCC", "H   H###H   H", "S   S###S   S", "S   S###S   S", "#SSS#####SSS#", "#SSS#####SSS#", "##S#######S##", "##S#######S##", "#############", "#############")
            .aisle("CCCCC###CCCCC", "H B H###H B H", "E B E###E B E", "E B E###E B E", "FSBSF###FSBSF", "FSBSF###FSBSF", "#SSS#####SSS#", "#SSS#####SSS#", "##S#######S##", "##E#######E##")
            .aisle("CCCCCFFFCCCCC", "H   H###H   H", "S   S###S   S", "S   S###S   S", "#SSS#####SSS#", "#SSS#####SSS#", "##S#######S##", "##S#######S##", "#############", "#############")
            .aisle("#CCCCCCCCCCC#", "#HHPSSSSSPHH#", "#SSPSSSSSPSS#", "#SSSSSSSSSSS#", "##F#CCCCC#F##", "##F#######F##", "#############", "#############", "#############", "#############")
            .aisle("##CCCCCCCCC##", "##SP     PS##", "##SP     PS##", "##SS     SS##", "##CCCCCCCCC##", "#############", "#############", "#############", "#############", "#############")
            .aisle("#CCCCCCCCCCC#", "#S   HBH   S#", "#S    B    S#", "#S    B    S#", "#CCEECCCEECC#", "###  ###  ###", "#############", "#############", "#############", "#############")
            .aisle("CCCCCCCCCCCCC", "S  H     H  S", "G           G", "S           S", "CCCEECCCEECCC", "###  ###  ###", "#############", "#############", "#############", "#############")
            .aisle("CCCCCCCCCCCCC", "S  B     B  S", "G  B     B  G", "S  B     B  S", "CCCCCCCCCCCCC", "#############", "#############", "#############", "#############", "#############")
            .aisle("CCCCCCCCCCCCC", "S  H     H  S", "G           G", "S           S", "CCCCCCCCCCCCC", "#############", "#############", "#############", "#############", "#############")
            .aisle("#CCCCCCCCCCC#", "#S   HBH   S#", "#S    B    S#", "#S    B    S#", "#CCCCCCCCCCC#", "#############", "#############", "#############", "#############", "#############")
            .aisle("##CCCCCCCCC##", "##SS     SS##", "##GG     GG##", "##SS     SS##", "#FCCCCCCCCCF#", "#############", "#############", "#############", "#############", "#############")
            .aisle("#F##CCCCC##F#", "#F##SC@CS##F#", "#F##GGGGG##F#", "#F##SSSSS##F#", "#FFFCCCCCFFF#", "#############", "#############", "#############", "#############", "#############")
            .where("@", Predicates.controller(Predicates.blocks(definition.get())))
            .where("C", Predicates.blocks("gtceu:sturdy_machine_casing").setMinGlobalLimited(30)
                .or(Predicates.autoAbilities(definition.getRecipeTypes()))
                .or(Predicates.abilities(PartAbility.INPUT_LASER).setMaxGlobalLimited(1))
                .or(Predicates.abilities(PartAbility.MAINTENANCE).setExactLimit(1))
                .or(Predicates.abilities(PartAbility.PARALLEL_HATCH).setMaxGlobalLimited(1)))
            .where("G", Predicates.blocks("gtceu:laminated_glass"))
            .where("F", Predicates.blocks("gtceu:hsse__frame"))
            .where("P", Predicates.blocks("gtceu:titanium_pipe_casing"))
            .where("B", Predicates.blocks("gtceu:titanium_gearbox"))
            .where("H", Predicates.blocks("gtceu:titanium_firebox_casing"))
            .where("E", Predicates.blocks("gtceu:engine_intake_casing"))
            .where("S", Predicates.blocks("gtceu:stable_machine_casing"))
            .where("#", Predicates.any())
            .where(" ", Predicates.air())
            .build())
        .workableCasingModel("gtceu:block/casings/solid/machine_casing_sturdy_hsse",
            "gtceu:block/machines/rock_crusher")
