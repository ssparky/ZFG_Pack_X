...
GTCEuStartupEvents.registry("gtceu:material", event => {
    ...
    event.create("twinite")
        ...
        .iconSet("magic")
        .blastTemp(7000, "highest", GTValues.VA[GTValues.ZPM], 1200)
    ...
    event.create("shellite")
        ...
        .iconSet("magic")
        .blastTemp(8200, "highest", GTValues.VA[GTValues.UV], 1400)
    ...
    event.create("dragonsteel")
        ...
        .iconSet("magic")
        .blastTemp(8800, "highest", GTValues.VA[GTValues.UHV], 1600)
    ...
    event.create("prismalium")
        ...
        .iconSet("magic")
        .blastTemp(9600, "highest", GTValues.VA[GTValues.UEV], 1000)
    ...
    event.create("melodium")
        ...
        .iconSet("magic")
        .blastTemp(10200, "highest", GTValues.VA[GTValues.UIV], 1200)
    ...
    event.create("stellarium")
        ...
        .iconSet("magic")
        .blastTemp(12000, "highest", GTValues.VA[GTValues.UXV], 2000)
