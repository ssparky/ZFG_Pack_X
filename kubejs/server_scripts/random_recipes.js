...
ServerEvents.recipes(event => {
    ...
    // Nether wart (why doesnt vanilla support this?)
    event.shaped("9x minecraft:nether_wart", ["minecraft:nether_wart_block"])

    // Calcite/Chalk stuff
    event.recipes.gtceu.macerator("ns_calcite_shard")
        .itemInputs("natures_spirit:calcite_shard")
        .itemOutputs("2x gtceu:calcite_dust")
        .chancedOutput("gtceu:calcite_dust", 5000, 0)
        .chancedOutput("gtceu:calcite_dust", 2500, 0)
        .EUt(GTValues.VA[GTValues.ULV])
        .duration(40)
    event.recipes.gtceu.autoclave("ns_calcite_shard_to")
        .itemInputs("2x gtceu:calcite_dust")
        .itemOutputs("natures_spirit:calcite_shard")
        .inputFluids("minecraft:water 2000")
        .EUt(GTValues.VA[GTValues.HV])
        .duration(120)
    event.recipes.gtceu.centrifuge("chalk_dust")
        .itemInputs("1x gtceu:calcite_dust")
        .chancedInput("aquaculture:algae", 1500, 0)
        .inputFluids("minecraft:water 250")
        .itemOutputs("natures_spirit:chalk_powder")
        .EUt(GTValues.VA[GTValues.ULV])
        .duration(240)
    event.recipes.gtceu.forge_hammer("chalk_from_dust")
        .itemInputs("3x natures_spirit:chalk_powder")
