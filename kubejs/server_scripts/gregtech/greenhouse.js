...
ServerEvents.recipes(event => {
    ...
    Greenhouse("oceanic_delight", "sea_grape", 640, ["16x oceanic_delight:sea_grape"], 0)
    ...
    Greenhouse("farmersdelight", "rice_panicle", 640, ["16x farmersdelight:rice"], 0)
    Greenhouse("farmersdelight", "rice", 640, ["16x farmersdelight:rice"], 0)
    Greenhouse("rusticdelight", "cotton_seeds", 640, ["16x farmersdelight:cotton_boll"], 0)
    Greenhouse("rusticdelight", "bell_pepper_seeds", 640, ["16x farmersdelight:bell_pepper_red"], 0)
    Greenhouse("rusticdelight", "coffee_beans", 640, ["16x farmersdelight:coffee_beans"], 0)
    Greenhouse("ends_delight", "chorus_fruit_grain", 640, ["16x minecraft:chorus_fruit"], 0)
    Greenhouse("ends_delight", "chorus_succulent", 640, ["16x ends_delight:chorus_succulent"], 0)
    Greenhouse("vinery", "cherry", 640, ["16x vinery:cherry"], 0)
    ...
    Greenhouse("farm_and_charm", "wild_nettle", 640, ["16x farm_and_charm:wild_nettle"], 0)
    Greenhouse("farm_and_charm", "wild_ribwort", 640, ["16x farm_and_charm:wild_ribwort"], 0)
    Greenhouse("brewery", "hops", 640, ["16x brewery:hops"], 0)
