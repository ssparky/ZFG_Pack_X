...
ServerEvents.recipes(event => {
    ...
    NullEngrave("lpic_wafer", "#forge:lenses/orange", "32x gtceu:lpic_wafer", 20);
    NullEngrave("mpic_wafer", "#forge:lenses/brown", "32x gtceu:mpic_wafer", 100);
    NullEngrave("simple_soc_wafer", "#forge:lenses/cyan", "32x gtceu:simple_soc_wafer", 20);
    NullEngrave("hasoc_wafer", "#forge:lenses/black", "4x gtceu:highly_advanced_soc_wafer", 500);
    NullEngrave("ulpic_wafer", "#forge:lenses/blue", "32x gtceu:ulpic_wafer", 20);
    NullEngrave("soc_wafer", "#forge:lenses/yellow", "16x gtceu:soc_wafer", 100);
    NullEngrave("asoc_wafer", "#forge:lenses/purple", "8x gtceu:advanced_soc_wafer", 200);
    NullEngrave("nand_wafer", "#forge:lenses/gray", "16x gtceu:nand_memory_wafer", 100);
    NullEngrave("nor_wafer", "#forge:lenses/pink", "16x gtceu:nor_memory_wafer", 100);
