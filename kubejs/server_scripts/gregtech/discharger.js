...
ServerEvents.recipes(event => {
    ...
    Discharge("abyssal_solar", "2x solarflux:sp_custom_abyssal", ["2x solarflux:sp_custom_bathyal", "4x gtceu:cryococcus_frame", hadal, bathyal], 20000000) 
    Discharge("bathyal_solar", "2x solarflux:sp_custom_bathyal", ["2x solarflux:sp_8", "4x gtceu:cryolobus_double_wire", "2x gtceu:cryolobus_block", bathyal], 20000000) 
