...
ServerEvents.recipes(event => {
    ...
    Discharge("abyssal_solar", "2x solarflux:sp_custom_abyssal", ["2x solarflux:sp_custom_bathyal", "4x minecraft:bedrock", hadal, bathyal], 20000000) // TODO: Replace bedrock, was LIO tier 9 card
    Discharge("bathyal_solar", "2x solarflux:sp_custom_bathyal", ["2x solarflux:sp_8", "4x minecraft:bedrock", "2x gtceu:cryolobus_block", bathyal], 20000000) // TODO: Replace bedrock, was LIO tier 8 card
