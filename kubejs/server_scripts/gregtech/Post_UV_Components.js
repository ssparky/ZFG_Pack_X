/**
 * Recipes for post-UV GT components - TODO: UIV/UXV/OPV
 */
...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line("uhv_motor")
        .itemInputs("gtceu:long_magnetic_terbium_rod", "8x gtceu:long_actinium_rod", "8x gtceu:actinium_ring", "16x gtceu:actinium_round", "64x gtceu:fine_darconite_wire", 
            "64x gtceu:fine_darconite_wire", "32x gtceu:fine_darconite_wire", "2x gtceu:lanthanum_gold_cadmium_curium_sulfate_single_cable")
    ...
    event.recipes.gtceu.assembly_line("uev_motor")
        .itemInputs("gtceu:long_magnetic_terbium_rod", "8x monilabs:long_sculk_bioalloy_rod", "8x monilabs:sculk_bioalloy_ring", "16x monilabs:sculk_bioalloy_round", 
            "64x gtceu:fine_necrosiderite_wire", "64x gtceu:fine_necrosiderite_wire", "48x gtceu:fine_necrosiderite_wire", "2x gtceu:darconite_single_cable")
    ...
    // TODO: UIV, UXV, OpV - change MAX recipes accordingly
    event.recipes.gtceu.assembly_line("max_electric_motor")
        .itemInputs("gtceu:long_magnetic_terbium_rod", "16x gtceu:long_monium_rod", "16x gtceu:monium_ring", "32x gtceu:monium_round", "64x gtceu:monium_single_wire", 
            "4x gtceu:hyperdegenerate_darconite_single_wire")
    ...
    event.recipes.gtceu.assembly_line("uhv_piston")
        .itemInputs("gtceu:uhv_electric_motor", "4x gtceu:actinium_plate", "4x gtceu:actinium_ring", "16x gtceu:actinium_round", "4x gtceu:actinium_rod", 
            "gtceu:actinium_gear", "2x gtceu:small_actinium_gear", "2x gtceu:lanthanum_gold_cadmium_curium_sulfate_single_cable")
        .inputFluids("gtceu:advanced_soldering_alloy 5760", "gtceu:lubricant 2000", "monilabs:crystal_matrix 576")
    ...
    event.recipes.gtceu.assembly_line("uev_piston")
        .itemInputs("gtceu:uev_electric_motor", "4x monilabs:sculk_bioalloy_plate", "4x monilabs:sculk_bioalloy_ring", "16x monilabs:sculk_bioalloy_round", 
            "4x monilabs:sculk_bioalloy_rod", "monilabs:sculk_bioalloy_gear", "2x monilabs:small_sculk_bioalloy_gear", "2x gtceu:darconite_single_cable")
        .inputFluids("gtceu:advanced_soldering_alloy 5760", "gtceu:lubricant 3000", "gtceu:neutronium 576")
    ...
    event.recipes.gtceu.assembly_line("max_piston")
        .itemInputs("2x monilabs:max_electric_motor", "8x gtceu:monium_plate", "8x gtceu:monium_ring", "8x gtceu:monium_round", "4x gtceu:monium_rod", 
            "2x gtceu:monium_gear", "4x gtceu:small_monium_gear", "4x gtceu:hyperdegenerate_darconite_single_wire")
        .inputFluids("gtceu:living_soldering_alloy 2880", "gtceu:lubricant 4000", "gtceu:infinity 144")
    ...
    event.recipes.gtceu.assembly_line("uhv_robot_arm")
        .itemInputs("4x gtceu:long_actinium_rod", "gtceu:actinium_gear", "3x gtceu:small_actinium_gear", "3x gtceu:uhv_electric_motor", "gtceu:uhv_electric_piston", 
            "#gtceu:circuits/uhv", "2x #gtceu:circuits/uv", "4x #gtceu:circuits/zpm", "4x gtceu:lanthanum_gold_cadmium_curium_sulfate_single_cable")
        .inputFluids("gtceu:advanced_soldering_alloy 5760", "gtceu:lubricant 2000", "monilabs:crystal_matrix 576")
    ...
    event.recipes.gtceu.assembly_line("uev_robot_arm")
        .itemInputs("4x monilabs:long_sculk_bioalloy_rod", "monilabs:sculk_bioalloy_gear", "3x monilabs:small_sculk_bioalloy_gear", "3x gtceu:uev_electric_motor", 
            "gtceu:uev_electric_piston", "#gtceu:circuits/uev", "2x #gtceu:circuits/uhv", "4x #gtceu:circuits/uv", "4x gtceu:darconite_single_cable")
        .inputFluids("gtceu:advanced_soldering_alloy 5760", "gtceu:lubricant 3000", "gtceu:neutronium 576")
    ...
    // TODO: UIV, UXV, OpV - change MAX recipes accordingly
        ...
        .itemInputs("8x gtceu:long_monium_rod", "2x gtceu:monium_gear", "6x gtceu:small_monium_gear", "6x monilabs:max_electric_motor", "2x monilabs:max_electric_piston", 
            "4x #gtceu:circuits/max", "8x #gtceu:circuits/uev", "16x #gtceu:circuits/uhv", "8x gtceu:hyperdegenerate_darconite_single_wire")
        .inputFluids("gtceu:living_soldering_alloy 2880", "gtceu:lubricant 4000", "gtceu:infinity 144")
    ...
    event.recipes.gtceu.assembly_line("uhv_sensor")
        .itemInputs("gtceu:manyullyn_frame", "gtceu:uhv_electric_motor", "4x gtceu:actinium_plate", "2x gtceu:gravi_star", "#gtceu:circuits/uhv", 
            "64x monilabs:crystal_matrix_foil", "32x monilabs:crystal_matrix_foil", "4x gtceu:lanthanum_gold_cadmium_curium_sulfate_single_cable")
    ...
    event.recipes.gtceu.assembly_line("uev_sensor")
        .itemInputs("monilabs:sculk_bioalloy_frame", "gtceu:uev_electric_motor", "4x monilabs:sculk_bioalloy_plate", "kubejs:quasi_stable_neutron_star", 
            "#gtceu:circuits/uev", "64x monilabs:transcendental_matrix_foil", "32x monilabs:transcendental_matrix_foil", "4x gtceu:darconite_single_cable")
    ...
    event.recipes.gtceu.assembly_line("max_sensor")
        .itemInputs("2x gtceu:monium_frame", "2x monilabs:max_electric_motor", "8x gtceu:monium_plate", "8x kubejs:quasi_stable_neutron_star", "4x #gtceu:circuits/max", 
            "64x gtceu:infinity_foil", "8x gtceu:hyperdegenerate_darconite_single_wire")
    ...
    event.recipes.gtceu.assembly_line("uhv_emitter")
        .itemInputs("gtceu:manyullyn_frame", "gtceu:uhv_electric_motor", "4x gtceu:long_actinium_rod", "2x gtceu:gravi_star", "#gtceu:circuits/uhv", 
            "64x monilabs:crystal_matrix_foil", "32x monilabs:crystal_matrix_foil", "4x gtceu:lanthanum_gold_cadmium_curium_sulfate_single_cable")
        .inputFluids("gtceu:advanced_soldering_alloy 5760", "monilabs:crystal_matrix 576")
    ...
    event.recipes.gtceu.assembly_line("uev_emitter")
        .itemInputs("monilabs:sculk_bioalloy_frame", "gtceu:uev_electric_motor", "4x monilabs:long_sculk_bioalloy_rod", "kubejs:quasi_stable_neutron_star", 
            "#gtceu:circuits/uev", "64x monilabs:transcendental_matrix_foil", "32x monilabs:transcendental_matrix_foil", "4x gtceu:darconite_single_cable")
        .inputFluids("gtceu:advanced_soldering_alloy 5760", "gtceu:neutronium 576")
    ...
    event.recipes.gtceu.assembly_line("max_emitter")
        .itemInputs("2x gtceu:monium_frame", "2x monilabs:max_electric_motor", "8x gtceu:long_monium_rod", "8x kubejs:quasi_stable_neutron_star", 
            "4x #gtceu:circuits/max", "64x gtceu:infinity_foil", "8x gtceu:hyperdegenerate_darconite_single_wire")
        .inputFluids("gtceu:living_soldering_alloy 2880", "gtceu:infinity 144")
    ...
    event.recipes.gtceu.assembly_line("uhv_field_generator")
        .itemInputs("gtceu:manyullyn_frame", "6x gtceu:actinium_plate", "2x gtceu:gravi_star", "2x gtceu:uhv_emitter", "2x #gtceu:circuits/uhv", 
            "64x gtceu:fine_ruthenium_trinium_americium_neutronate_wire", "64x gtceu:fine_ruthenium_trinium_americium_neutronate_wire", "4x gtceu:lanthanum_gold_cadmium_curium_sulfate_single_cable")
        .inputFluids("gtceu:advanced_soldering_alloy 5760", "monilabs:crystal_matrix 576")
    ...
    event.recipes.gtceu.assembly_line("uhv_conveyor")
        .itemInputs("2x gtceu:uhv_electric_motor", "2x gtceu:actinium_plate", "4x gtceu:actinium_ring", "16x gtceu:actinium_round", "4x gtceu:actinium_screw", 
            "2x gtceu:lanthanum_gold_cadmium_curium_sulfate_single_cable")
    ...
    event.recipes.gtceu.assembly_line("uev_conveyor")
        .itemInputs("2x gtceu:uev_electric_motor", "2x monilabs:sculk_bioalloy_plate", "4x monilabs:sculk_bioalloy_ring", "16x monilabs:sculk_bioalloy_round", 
            "4x monilabs:sculk_bioalloy_screw", "2x gtceu:darconite_single_cable")
    ...
    event.recipes.gtceu.assembly_line("max_conveyor_module")
        .itemInputs("4x monilabs:max_electric_motor", "8x gtceu:monium_plate", "8x gtceu:monium_ring", "32x gtceu:monium_round", "8x gtceu:monium_screw", 
            "4x gtceu:hyperdegenerate_darconite_single_wire")
        .inputFluids("gtceu:living_soldering_alloy 2880", "gtceu:lubricant 4000", "gtceu:infinity 144")
    ...
    event.recipes.gtceu.assembly_line("uhv_pump")
        .itemInputs("gtceu:uhv_electric_motor", "gtceu:neutronium_large_fluid_pipe", "2x gtceu:actinium_plate", "8x gtceu:actinium_screw", "16x gtceu:silicone_rubber_ring", 
            "gtceu:neutronium_rotor", "2x gtceu:lanthanum_gold_cadmium_curium_sulfate_single_cable")
        .inputFluids("gtceu:advanced_soldering_alloy 5760", "gtceu:lubricant 2000", "monilabs:crystal_matrix 576")
    ...
    event.recipes.gtceu.assembly_line("uev_pump")
        .itemInputs("gtceu:uev_electric_motor", "gtceu:meta_null_large_fluid_pipe", "2x monilabs:sculk_bioalloy_plate", "8x monilabs:sculk_bioalloy_screw", 
            "16x gtceu:silicone_rubber_ring", "gtceu:meta_null_rotor", "2x gtceu:darconite_single_cable")
        .inputFluids("gtceu:advanced_soldering_alloy 5760", "gtceu:lubricant 3000", "gtceu:neutronium 576")
    ...
    event.recipes.gtceu.assembly_line("max_electric_pump")
        .itemInputs("2x monilabs:max_electric_motor", "gtceu:meta_null_huge_fluid_pipe", "8x gtceu:monium_plate", "16x gtceu:monium_screw", 
            "64x gtceu:silicone_rubber_ring", "4x gtceu:monium_rotor", "8x gtceu:hyperdegenerate_darconite_single_wire")
        .inputFluids("gtceu:living_soldering_alloy 2880", "gtceu:lubricant 4000", "gtceu:infinity 144")
