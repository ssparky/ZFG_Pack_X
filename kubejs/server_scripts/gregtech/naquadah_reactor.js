...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.assembly_line("kubejs:naquadah_refinery")
        .itemInputs("gtceu:large_mixer", "4x #gtceu:circuits/uv", "8x kubejs:elite_radiation_shielding_plate", "4x gtceu:zpm_field_generator", "4x gtceu:uv_hermetic_casing", "2x kubejs:empty_fuel_rod", "2x gtceu:zpm_electric_pump", "2x gtceu:duranium_huge_fluid_pipe", "16x kubejs:cryotheum_dust", "16x gtceu:double_tritanium_plate")
