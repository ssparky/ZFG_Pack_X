...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.gas_collector("moon_air")
        ...
        .outputFluids(Fluid.of("gtceu:moon_air", 10000))
        .circuit(5)
        .EUt(512)
        .duration(200)
    ...
    event.recipes.gtceu.gas_collector("mercury_air")
        ...
        .outputFluids(Fluid.of("gtceu:mercury_air", 10000))
        .circuit(8)
        .EUt(512)
        .duration(200)
    event.recipes.gtceu.gas_collector("glacio_air")
    ...
    // Air freezing
    event.recipes.gtceu.vacuum_freezer("moon_air_freezing")
        .inputFluids("gtceu:moon_air 4000")
        .outputFluids("gtceu:liquid_moon_air 4000")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(200)
    event.recipes.gtceu.vacuum_freezer("mars_air_freezing")
        .inputFluids("gtceu:mars_air 4000")
        .outputFluids("gtceu:liquid_mars_air 4000")
        .EUt(GTValues.VA[GTValues.EV])
        .duration(200)
    event.recipes.gtceu.vacuum_freezer("venus_air_freezing")
        .inputFluids("gtceu:venus_air 4000")
        .outputFluids("gtceu:liquid_venus_air 4000")
        .EUt(GTValues.VA[GTValues.EV])
        .duration(200)
    event.recipes.gtceu.vacuum_freezer("mercury_air_freezing")
        .inputFluids("gtceu:mercury_air 4000")
        .outputFluids("gtceu:liquid_mercury_air 4000")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(200)
    event.recipes.gtceu.vacuum_freezer("glacio_air_freezing")
        .inputFluids("gtceu:glacio_air 4000")
        .outputFluids("gtceu:liquid_glacio_air 4000")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(200)

    // Air distillation
    event.recipes.gtceu.distillation_tower("moon_air_distillation")
        .inputFluids("gtceu:liquid_moon_air 40000")
        .chancedOutput("kubejs:moon_dust", 4000, 0)
        .outputFluids("gtceu:argon 21000", "gtceu:neon 10000", "gtceu:helium 5000", "gtceu:sodium_potassium 2000", "gtceu:deuterium 1000",
            "gtceu:polonium 500", "gtceu:radon 500",
        )
        .duration(800)
        .EUt(GTValues.VA[GTValues.IV])
    event.recipes.gtceu.distillation_tower("mars_air_distillation")
        .inputFluids("gtceu:liquid_mars_air 200000")
        .chancedOutput("kubejs:mars_dust", 4000, 0)
        .outputFluids("gtceu:carbon_dioxide 161000", "gtceu:nitrogen 24000", "gtceu:argon 4000", "gtceu:oxygen 3000", "minecraft:water 2000", "gtceu:methane 2000",
            "gtceu:sulfur_dioxide 1000", "gtceu:carbon_monoxide 1000", "gtceu:neon 1000", "gtceu:krypton 1000"
        )
        .duration(800)
        .EUt(GTValues.VA[GTValues.IV])
    event.recipes.gtceu.distillation_tower("venus_air_distillation")
        .inputFluids("gtceu:liquid_venus_air 100000")
        .chancedOutput("kubejs:venus_dust", 4000, 0)
        .outputFluids("gtceu:carbon_dioxide 80000", "gtceu:nitrogen 5000", "gtceu:sulfur_dioxide 3000", "gtceu:deuterium 3000", "gtceu:hydrochloric_acid 2500", 
            "gtceu:hydrofluoric_acid 2500", "gtceu:carbon_monoxide 2000", "gtceu:sulfuric_acid 1000", "gtceu:xenon 1000"
        )
        .duration(800)
        .EUt(GTValues.VA[GTValues.IV])
    event.recipes.gtceu.distillation_tower("mercury_air_distillation")
        .inputFluids("gtceu:liquid_mercury_air 80000")
        .chancedOutput("kubejs:mercury_dust", 4000, 0)
        .outputFluids("gtceu:hydrogen 32000", "gtceu:deuterium 28000", "gtceu:argon 7000", "gtceu:helium 6000", "gtceu:helium_3 4000", "gtceu:oxygen 2000", 
            "gtceu:sodium_potassium 1000"
        )
        .duration(800)
        .EUt(GTValues.VA[GTValues.LuV])
    event.recipes.gtceu.distillation_tower("glacio_air_distillation")
        .inputFluids("gtceu:liquid_glacio_air 200000")
        .chancedOutput("kubejs:glacio_dust", 4000, 0)
        .outputFluids("gtceu:ammonia 140000", "minecraft:water 24000", "gtceu:chlorobenzene 16000", "gtceu:dichlorobenzene 8000", "kubejs:molten_cryotheum 6000", 
            "gtceu:xenon 3000", "gtceu:radon 2000", "gtceu:oganesson 1000" 
        )
        .duration(800)
