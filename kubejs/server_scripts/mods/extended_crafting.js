...
ServerEvents.recipes(event => {
    ...
    event.recipes.gtceu.large_combination_crafter("envenomed_quiver")
        .itemInputs("1x moreartifacts:magic_quiver", "1x moreartifacts:venom_amulet", Item.of('minecraft:tipped_arrow', 3, '{Potion:"minecraft:long_poison"}'))
        .itemOutputs("1x moreartifacts:envenomed_quiver")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1966080/32768)
    event.recipes.gtceu.large_combination_crafter("shulked_clock")
        .itemInputs("1x gtceu:mythril_gear", "1x moreartifacts:shulker_heart", "1x moreartifacts:fast_clock", "2x create:pulse_timer", "3x gtceu:caesium_dust")
        .itemOutputs("1x moreartifacts:shulked_clock")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1966080/32768)
    event.recipes.gtceu.large_combination_crafter("purification_charm")
        .itemInputs("1x gtceu:mythril_gear", "1x moreartifacts:nectar", "1x moreartifacts:desert_charm", "1x minecraft:flowering_azalea", "3x gtceu:gold_foil")
        .itemOutputs("1x moreartifacts:shulked_clock")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1966080/32768)
    event.recipes.gtceu.large_combination_crafter("ankh_charm")
        .itemInputs("1x gtceu:electrum_plate", "1x moreartifacts:sculk_shades", "1x moreartifacts:withered_bezoar", 
            "1x moreartifacts:shulked_clock", "1x moreartifacts:purification_charm", "1x moreartifacts:vitamins", "2x gtceu:cinnabar_dust")
        .itemOutputs("1x moreartifacts:ankh_charm")
        .EUt(GTValues.VA[GTValues.LuV])
    ...
    event.recipes.gtceu.large_combination_crafter("necroplasm_amulet")
        ...
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(7864320/131072)
    event.recipes.gtceu.large_combination_crafter("infinity_ingot")
        .itemInputs("1x kubejs:active_prismatic_core", "2x gtceu:activated_netherite_ingot", "2x gtceu:neutronium_ingot", "4x monilabs:transcendental_matrix_ingot")
        .itemOutputs("2x gtceu:infinity_ingot")
        .EUt(GTValues.VA[GTValues.UHV])
        .duration(320000000/8000000)
    event.recipes.gtceu.large_combination_crafter("decay_stone")
        .itemInputs("1x minecraft:lodestone", "1x moreartifacts:wither_shard", "1x moreartifacts:decay_amulet", "5x gtceu:exquisite_anatase_gem")
        .itemOutputs("1x moreartifacts:decay_stone")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(7864320/131072)
    event.recipes.gtceu.large_combination_crafter("fire_stone")
        .itemInputs("1x minecraft:lodestone", "1x artifacts:obsidian_skull", "1x artifacts:flame_pendant", "5x gtceu:exquisite_triplite_gem")
        .itemOutputs("1x moreartifacts:fire_stone")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(7864320/131072)
    event.recipes.gtceu.large_combination_crafter("prismatic_focus")
        .itemInputs("1x minecraft:beacon", "1x #forge:lenses/light_blue", "1x #forge:lenses/green", "1x #forge:lenses/red", 
            "1x #forge:lenses/blue", "1x #forge:lenses/purple", "1x #forge:lenses/yellow")
        .itemOutputs("1x monilabs:prismatic_focus")
        .EUt(GTValues.VA[GTValues.UV])
        .duration(20000000/2000000)
    event.recipes.gtceu.large_combination_crafter("withered_bezoar")
        .itemInputs("1x gtceu:mythril_gear", "1x moreartifacts:bezoar", "1x moreartifacts:wither_shard", "4x gtceu:thallium_dust", "2x kubejs:solidified_bromine")
        .itemOutputs("1x moreartifacts:withered_bezoar")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1966080/32768)
    event.recipes.gtceu.large_combination_crafter("ice_stone")
        .itemInputs("1x minecraft:lodestone", "1x moreartifacts:ice_crystal", "1x artifacts:shock_pendant", "5x gtceu:exquisite_bazzite_gem")
        .itemOutputs("1x moreartifacts:ice_stone")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(7864320/131072)
    event.recipes.gtceu.large_combination_crafter("amphibian_boot")
        .itemInputs("1x moreartifacts:dune_treads", "1x artifacts:snorkel", "1x artifacts:flippers", "2x minecraft:verdant_froglight", "3x gtceu:watertight_steel_dust")
        .itemOutputs("1x relics:amphibian_boot")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1966080/32768)
    event.recipes.gtceu.large_combination_crafter("sculk_shades")
        .itemInputs("1x gtceu:mythril_gear", "1x moreartifacts:sunglasses", "1x moreartifacts:sculk_lens", "2x kubejs:warden_horn", "2x mcwwindows:one_way_glass")
        .itemOutputs("1x moreartifacts:sculk_shades")
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1966080/32768)
    event.recipes.gtceu.large_combination_crafter("universe_resistant_neutronium_plating")
        .itemInputs("1x gtceu:double_neutronium_plate", "3x gtceu:quantum_eye", "1x gtceu:omnium_nugget")
    ...
    event.recipes.gtceu.large_combination_crafter("molten_quiver")
        ...
        .EUt(GTValues.VA[GTValues.IV])
        .duration(1966080/32768)
    event.recipes.gtceu.large_combination_crafter("elementally_infused_omnic_matrix_plating")
        .itemInputs("1x gtceu:double_omnium_plate", "2x monilabs:crystal_matrix_plate", "1x gtceu:gravi_star", "1x gtceu:neutron_reflector", "3x kubejs:primal_mana")
        .itemOutputs("1x kubejs:elementally_infused_omnic_matrix_heavy_plating")
        .EUt(GTValues.VA[GTValues.ZPM])
    ...
    event.recipes.gtceu.large_combination_crafter("dimensionally_stabilized_infinity_plating")
        ...
        .EUt(GTValues.VA[GTValues.UV])
        .duration(16000000/1600000)
    event.recipes.gtceu.large_combination_crafter("venom_stone")
        .itemInputs("1x minecraft:lodestone", "1x moreartifacts:bezoar", "1x moreartifacts:venom_amulet", "5x gtceu:exquisite_zoisite_gem")
        .itemOutputs("1x moreartifacts:venom_stone")
        .EUt(GTValues.VA[GTValues.LuV])
        .duration(7864320/131072)
    event.recipes.gtceu.large_combination_crafter("netherite_scrap_activation")
        .itemInputs("1x kubejs:reactive_netherite_cluster", "4x gtceu:activated_carbon_dust", "4x gtceu:void_gem")
        .itemOutputs("1x kubejs:activated_netherite_scrap")
        .EUt(GTValues.VA[GTValues.ZPM])
        .duration(32000000/1600000)
})
